...
TSAN_INTERCEPTOR(int, pthread_mutex_init, void *m, void *a) {
  ...
  Printf("mutex init pc:%lu mutexAddress:%p\n",pc,m);
...
TSAN_INTERCEPTOR(int, pthread_mutex_lock, void *m) {
  ...
  Printf("mutex lock pc:%lu the mutexAddress:%p\n",pc,m);
...
TSAN_INTERCEPTOR(int, pthread_mutex_unlock, void *m) {
  ...
  Printf("mutex unlock pc:%lu mutexAddress:%p\n",pc,m);
  MutexUnlock(thr, pc, (uptr)m);
...
TSAN_INTERCEPTOR(int, __pthread_mutex_lock, void *m) {
  ...
  Printf("mutex lock pc:%lu mutexAddress:%p\n",pc,m);
  MutexPreLock(thr, pc, (uptr)m);
